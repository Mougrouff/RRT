...
(cl:defmethod cl:initialize-instance :after ((m <Occupancy-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Occupancy-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planification-srv:<Occupancy-request> is deprecated: use planification-srv:Occupancy-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Occupancy-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planification-srv:pose-val is deprecated.  Use planification-srv:pose instead.")
  (pose m))

(cl:ensure-generic-function 'occupancy-val :lambda-list '(m))
(cl:defmethod occupancy-val ((m <Occupancy-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planification-srv:occupancy-val is deprecated.  Use planification-srv:occupancy instead.")
  (occupancy m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Occupancy-request>)))
  ...
  "planification/OccupancyRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Occupancy-request)))
  "Returns string type for a service object of type 'Occupancy-request"
  "planification/OccupancyRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Occupancy-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Occupancy-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planification-srv:<Occupancy-response> is deprecated: use planification-srv:Occupancy-response instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <Occupancy-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planification-srv:path-val is deprecated.  Use planification-srv:path instead.")
  (path m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Occupancy-response>)))
  ...
  "planification/OccupancyResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Occupancy-response)))
  "Returns string type for a service object of type 'Occupancy-response"
  "planification/OccupancyResponse")
